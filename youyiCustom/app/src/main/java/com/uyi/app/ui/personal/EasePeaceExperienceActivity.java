 ...
 */
@ContentView(R.layout.ease_peace_experience)
public class EasePeaceExperienceActivity extends BaseActivity implements DialogInterface.OnClickListener {
    ...
    public void requestBuyPackage(int id) {
        ...
        RequestManager.postObject(Constens.BUY_SERVICE_PACKAGE, this, object, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                T.showShort(EasePeaceExperienceActivity.this, "购买成功！");
            ...
            public void requestError(VolleyError e) {
                if (e.networkResponse != null) {
                    if (e.networkResponse.statusCode == 200) {
                        T.showShort(activity, "购买成功！");  sendBroadcast(new Intent("com.uyi.beans"));
                        onBackPressed();
                    } else {
