...
//	// 存放更新APK文件的路径
//	public static final String UPDATE_DOWNURL = "http://192.169.1.108:8080/youyiDoctor.apk";
//	// 存放更新APK文件相应的版本说明路径
//	public static final String UPDATE_CHECKURL =  "http://192.169.1.108:8080/youyiDoctor.txt";
	
	// 存放更新APK文件的路径
	public static final String UPDATE_DOWNURL = Constens.SERVER_URL+"/android/youyiDoctor.apk";
	// 存放更新APK文件相应的版本说明路径
	public static final String UPDATE_CHECKURL =  Constens.SERVER_URL+"/android/youyiDoctor.txt";
	
	public static final String UPDATE_APKNAME = "youyiDoctor.apk";
	public static final String UPDATE_SAVENAME = "youyiDoctor.apk";
