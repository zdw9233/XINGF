...
public class HealthDatabasePreviewActivity extends BaseActivity implements OnClickListener {
...
//            public void run() {
        try {
            Loading.bulid(activity, null).show();
                RequestManager.postObject(Constens.HEALTH_CHECK_INFOS_SAVE, activity, data, new Listener<JSONObject>() {
