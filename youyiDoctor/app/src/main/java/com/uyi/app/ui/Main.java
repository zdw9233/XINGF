...
public class Main extends BaseFragmentActivity  {
	...
	@ViewInject(R.id.main_tab_1) 	public LinearLayout main_tab_1;
	@ViewInject(R.id.main_tab_2) 	public LinearLayout main_tab_2;
	@ViewInject(R.id.main_tab_3)	public LinearLayout main_tab_3;
	@ViewInject(R.id.main_tab_4) 	public LinearLayout main_tab_4;

	@ViewInject(R.id.main_tab_1_icon) private ImageView main_tab_1_icon;
	@ViewInject(R.id.main_tab_2_icon) private ImageView main_tab_2_icon;
	@ViewInject(R.id.main_tab_3_icon) private ImageView main_tab_3_icon;
	@ViewInject(R.id.main_tab_4_icon) private ImageView main_tab_4_icon;

	@ViewInject(R.id.main_tab_1_text) private TextView main_tab_1_text;
	@ViewInject(R.id.main_tab_2_text) private TextView main_tab_2_text;
	@ViewInject(R.id.main_tab_3_text) private TextView main_tab_3_text;
	@ViewInject(R.id.main_tab_4_text) private TextView main_tab_4_text;

	@ViewInject(R.id.main_tab_1_count) private TextView main_tab_1_count;
	@ViewInject(R.id.main_tab_2_count) private TextView main_tab_2_count;
	// 点击事件
