...
public class CustomInfoActivity extends BaseActivity {
    ...
    @ViewInject(R.id.constom_info_logo)
    private RoundedImageView constom_info_logo;
    @ViewInject(R.id.constom_info_name)
    private TextView constom_info_name;
    @ViewInject(R.id.docter)
    private TextView docter;
    @ViewInject(R.id.guaridon)
    private TextView guaridon;
    @ViewInject(R.id.service_pakege)
    private TextView service_pakege;
    @ViewInject(R.id.constom_info_gender)
    private TextView constom_info_gender;
    @ViewInject(R.id.constom_info_chushengriqi)
    private TextView constom_info_chushengriqi;

    @ViewInject(R.id.custom_jiankang)
    private TextView custom_jiankang;
    @ViewInject(R.id.custom_gereng)
    private TextView custom_gereng;
    @ViewInject(R.id.custom_jiuyi)
    private TextView custom_jiuyi;
    @ViewInject(R.id.custom_yaowu)
    private TextView custom_yaowu;
    @ViewInject(R.id.custom_xueguan)
    private TextView custom_xueguan;


    @ViewInject(R.id.custom_jiankang_info)
    private LinearLayout custom_jiankang_info; //健康资料
    @ViewInject(R.id.custom_zhongdu)
    private TextView custom_zhongdu;
    @ViewInject(R.id.custom_xitonghuigu)
    private TextView custom_xitonghuigu;
    @ViewInject(R.id.custom_yufangjiezhonshi)
    private TextView custom_yufangjiezhonshi;
    @ViewInject(R.id.custom_jiwangbinshi)
    private TextView custom_jiwangbinshi;
    @ViewInject(R.id.custom_chuanranbinshi)
    private TextView custom_chuanranbinshi;
    @ViewInject(R.id.custom_waishangshi)
    private TextView custom_waishangshi;
    @ViewInject(R.id.custom_shoushushi)
    private TextView custom_shoushushi;
    @ViewInject(R.id.custom_huaiyun_liuchan)
    private TextView custom_huaiyun_liuchan;
    @ViewInject(R.id.custom_yuejing)
    private TextView custom_yuejing;
    @ViewInject(R.id.custom_shiwuguoming)
    private TextView custom_shiwuguoming;
    @ViewInject(R.id.custom_shuxueshi)
    private TextView custom_shuxueshi;
    @ViewInject(R.id.custom_jiazhubingshi)
    private TextView custom_jiazhubingshi;
    @ViewInject(R.id.custom_muqianfuyao)
    private TextView custom_muqianfuyao;
    @ViewInject(R.id.custom_qitabuchong)
    private TextView custom_qitabuchong;
    @ViewInject(R.id.custom_qitabubingshi)
    private TextView custom_qitabubingshi;
    @ViewInject(R.id.custom_yuejing_layout)
    private LinearLayout custom_yuejing_layout; //月经史
    @ViewInject(R.id.custom_huaiyun_liuchan_layout)
    private LinearLayout custom_huaiyun_liuchan_layout; //怀孕史

    @ViewInject(R.id.custom_gerent_info)
    private LinearLayout custom_gerent_info; //个人资料
    @ViewInject(R.id.custom_city)
    private TextView custom_city;
    @ViewInject(R.id.custom_address)
    private TextView custom_address;
    @ViewInject(R.id.custom_phone)
    private TextView custom_phone;
    @ViewInject(R.id.custom_mobile)
    private TextView custom_mobile;
    @ViewInject(R.id.custom_email)
    private TextView custom_email;
    @ViewInject(R.id.custom_zhiye)
    private TextView custom_zhiye;


    @ViewInject(R.id.custom_xueguan_layout)
    private LinearLayout custom_xueguan_layout; //血管事件
    @ViewInject(R.id.custom_xueguan_time)
    private TextView custom_xueguan_time;
    @ViewInject(R.id.custom_xueguan_neixin)
    private TextView custom_xueguan_neixin;
    @ViewInject(R.id.custom_xueguan_miaoshu)
    private TextView custom_xueguan_miaoshu;

    @ViewInject(R.id.custom_yaowu_layout)
    private LinearLayout custom_yaowu_layout; //药物情况
    @ViewInject(R.id.custom_yaowu_guomin)
    private TextView custom_yaowu_guomin;
    @ViewInject(R.id.custom_yaowu_ying)
    private TextView custom_yaowu_ying;

    @ViewInject(R.id.custom_jiuyi_layout)
    private LinearLayout custom_jiuyi_layout; //基本情况
    @ViewInject(R.id.custom_shengao)
    private TextView custom_shengao;
    @ViewInject(R.id.custom_tizhong)
    private TextView custom_tizhong;
    @ViewInject(R.id.custom_jibing)
    private TextView jibing;
    @ViewInject(R.id.custom_jiankanzhuangkuang)
    private TextView jiankanzhuangk;
        ...
        RequestManager.getObject(String.format(Constens.DOCTOR_QUERY_CUSTOMER_INFO, customId), activity, new Listener<JSONObject>() {
            public void onResponse(JSONObject data) {
                try {
                    ...
                    custom_address.setText(JSONObjectUtils.getString(data, "address").equals("null") ? "" : JSONObjectUtils.getString(data, "address"));
                    custom_mobile.setText(JSONObjectUtils.getString(data, "phoneNumber").equals("null") ? "" : JSONObjectUtils.getString(data, "phoneNumber"));
                    custom_phone.setText(JSONObjectUtils.getString(data, "backupPhoneNumber").equals("null") ? "" : JSONObjectUtils.getString(data, "backupPhoneNumber"));
                    custom_email.setText(JSONObjectUtils.getString(data, "email").equals("null") ? "" : JSONObjectUtils.getString(data, "email"));
                    custom_zhiye.setText(JSONObjectUtils.getString(data, "occupation").equals("null") ? "" : JSONObjectUtils.getString(data, "occupation"));
...
//					}
                    ...
                    if (data.has("healthCondition"))
                        jiankanzhuangk.setText(JSONObjectUtils.getString(data, "healthCondition").equals("null") ? "" : JSONObjectUtils.getString(data, "healthCondition"));
...
//						custom_qitabuchong.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "others").equals("null")?"无":JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "others"));
                        if (data.getJSONObject("healthInfo").has("vaccinationHistory"))
                            custom_yufangjiezhonshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "vaccinationHistory").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "vaccinationHistory"));
                        if (data.getJSONObject("healthInfo").has("blood"))
                            custom_shuxueshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "blood").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "blood"));
                        if (data.getJSONObject("healthInfo").has("trauma"))
                            custom_waishangshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "trauma").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "trauma"));
                        if (data.getJSONObject("healthInfo").has("medical"))
                            custom_jiwangbinshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "medical").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "medical"));
                        if (data.getJSONObject("healthInfo").has("infection"))
                            custom_chuanranbinshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "infection").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "infection"));
                        if (data.getJSONObject("healthInfo").has("operation"))
                            custom_shoushushi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "operation").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "operation"));
                        if (data.getJSONObject("healthInfo").has("pregnancy"))
                            custom_huaiyun_liuchan.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "pregnancy").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "pregnancy"));
                        if (data.getJSONObject("healthInfo").has("menstruation"))
                            custom_yuejing.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "menstruation").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "menstruation"));
                        if (data.getJSONObject("healthInfo").has("allergic"))
                            custom_shiwuguoming.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "allergic").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "allergic"));
                        if (data.getJSONObject("healthInfo").has("familyMedical"))
                            custom_jiazhubingshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "familyMedical").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "familyMedical"));
                        custom_muqianfuyao.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "current").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "current"));
                        custom_qitabubingshi.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "others").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "others"));
                        custom_zhongdu.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "allergic").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "allergic"));
                        custom_xitonghuigu.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "retrospection").equals("null") ? "" : JSONObjectUtils.getString(data.getJSONObject("healthInfo"), "retrospection"));
                        ...
                        if( !data.getJSONObject("healthInfo").getString("externalSituations").equals("null")) {
                        ...
                        if( !data.getJSONObject("healthInfo").getString("medicationUsingSituations").equals("null")){
                        ...
                        if (data.getJSONObject("healthInfo").has("abnormalEventJsons")&& !data.getJSONObject("healthInfo").getString("abnormalEventJsons").equals("null")) {

                            if (data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons").has("time"))
                                custom_xueguan_time.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons"), "time").equals("null") ? "" :JSONObjectUtils.getString(data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons"), "time"));
                            if (data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons").has("name"))
                                custom_xueguan_neixin.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons"), "name").equals("null") ? "" :JSONObjectUtils.getString(data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons"), "name"));
                            if (data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons").has("description"))
                                custom_xueguan_miaoshu.setText(JSONObjectUtils.getString(data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons"), "description").equals("null") ? "" :JSONObjectUtils.getString(data.getJSONObject("healthInfo").getJSONObject("abnormalEventJsons"), "description"));
                        }
