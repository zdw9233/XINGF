...
public class RecyclerListener extends RecyclerView.OnScrollListener {
    ...
    /** 加载更多的监听 */
    private net.bodecn.lib.widget.recycler.RecyclerView.LoadMoreListener mListener;
     ...
     *            加载更多的监听
     */
    public RecyclerListener(net.bodecn.lib.widget.recycler.RecyclerView.LoadMoreListener listener) {
        mListener = listener;
    }
