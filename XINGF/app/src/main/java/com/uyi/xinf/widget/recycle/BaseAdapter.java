...
public abstract class BaseAdapter extends
     ...
     * Item点击事件对象
     */
    private com.uyi.xinf.widget.recycle.RecyclerView.ItemClickListener mItemClickListener;

    /**
     * Item长按点击事件对象
     */
    private com.uyi.xinf.widget.recycle.RecyclerView.ItemLongClickListener mItemLongClickListener;
...
//                                             null);
//                // 设置颜色
//                ProgressWheel progressWheel = (ProgressWheel) loadMore.findViewById(R.id.progress);
//                progressWheel.setBarColor(mContext.getResources()
//                                                  .getColor(barColorResId()));
//                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
//                                                                             ViewGroup.LayoutParams.WRAP_CONTENT);
//                loadMore.setLayoutParams(lp);
//                loadMore.setEnabled(false);
//                return newHolder(loadMore);
            default:
     ...
     */
    public void setItemClickListener(com.uyi.xinf.widget.recycle.RecyclerView.ItemClickListener itemClickListener) {
     ...
     */
    public void setItemLongClickListener(com.uyi.xinf.widget.recycle.RecyclerView.ItemLongClickListener itemLongClickListener) {
