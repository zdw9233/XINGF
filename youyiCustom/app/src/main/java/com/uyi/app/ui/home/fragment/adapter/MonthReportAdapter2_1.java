 ...
 *
 */
public class MonthReportAdapter2_1 extends BaseRecyclerAdapter<Map<String,Object>> {

	public Context context;
	private ArrayList<Integer> showDetailPositions;
	public MonthReportAdapter2_1(Context context) {
	...
	public void onBind(final ViewHolder viewHolder, final int RealPosition, final Map<String, Object> data) {
		if(viewHolder instanceof Holder){
			...
			hodler.title.setText(data.get("endTime").toString().substring(0,10).replace("-",".")+"月度健康报告");
