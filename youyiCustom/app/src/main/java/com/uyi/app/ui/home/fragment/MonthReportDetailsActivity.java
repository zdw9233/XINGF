...
import com.uyi.app.ui.home.fragment.model.MonthReport;
        ...
        RequestManager.getObject(String.format(Constens.DOCTOR_HEALTH_MONTH_AND_QUA_DETAILS, startData, endData),
                activity, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject data) {
                        L.e(data.toString());
                        quaReport = JSON.parseObject(data.toString(), MonthReport.class);
                        ...
                        img_xy_text.setText(quaReport.getBloodPressureText());
                        img_xt_text.setText(quaReport.getBloodSugarText());
