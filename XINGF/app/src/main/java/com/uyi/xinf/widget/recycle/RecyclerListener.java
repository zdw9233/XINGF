...
public class RecyclerListener extends RecyclerView.OnScrollListener {
     ...
     * 加载更多的监听
     */
    private com.uyi.xinf.widget.recycle.RecyclerView.LoadMoreListener mListener;
     ...
     */
    public RecyclerListener(com.uyi.xinf.widget.recycle.RecyclerView.LoadMoreListener listener) {
        mListener = listener;
    }
