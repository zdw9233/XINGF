...
public class RegisterActivity extends BaseActivity implements IOnItemSelectListener, OnDateSetListener,EndlessRecyclerView.Pager, SwipeRefreshLayout.OnRefreshListener {
	...
	@ViewInject(R.id.regester_main) private LinearLayout mMainView; 
	@ViewInject(R.id.register_xieyi) private TextView register_xieyi;
	@ViewInject(R.id.register_one_layout) private LinearLayout register_one_layout;
	@ViewInject(R.id.register_one_next) private Button register_one_next;
	@ViewInject(R.id.register_one_return) private Button register_one_return;
	
	@ViewInject(R.id.register_two_layout) private LinearLayout register_two_layout;
	@ViewInject(R.id.register_username) private EditText register_username;
	@ViewInject(R.id.register_pwd) private EditText register_pwd;
	@ViewInject(R.id.register_pwds) private EditText register_pwds;
	@ViewInject(R.id.register_wenti) private TextView register_wenti;
	@ViewInject(R.id.register_dywenti_layout) private LinearLayout register_dywenti_layout;
	@ViewInject(R.id.register_zidingyiwenti) private EditText register_zidingyiwenti;
	@ViewInject(R.id.register_daan) private EditText register_daan;
	@ViewInject(R.id.register_two_next) private Button register_two_next;
	...
	@ViewInject(R.id.register_xinbie) private TextView register_xinbie;
	...
	@ViewInject(R.id.register_four_layout) private LinearLayout register_four_layout;
	@ViewInject(R.id.regester_four_city_layout) private LinearLayout regester_four_city_layout;
	@ViewInject(R.id.register_four_shen) private TextView register_four_shen;
	@ViewInject(R.id.register_four_city) private TextView register_four_city;
	...
	@ViewInject(R.id.register_five_layout) private LinearLayout register_five_layout;
	@ViewInject(R.id.register_five_setting) private Button register_five_setting;
	@ViewInject(R.id.register_five_return) private Button register_five_return;
