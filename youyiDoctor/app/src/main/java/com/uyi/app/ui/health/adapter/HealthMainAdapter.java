...
/**
 * Created by Leeii on 2016/6/18.
 */
public class HealthMainAdapter extends BaseAdapter {
    private String[] titleTextCN = new String[]{"健康报告", "健康数据库", "主诊报告", "风险评估", "生活方式", "饮食计划", "设置报警"};
    private String[] titleTextEN = new String[]{"report", "database", "diagnosis", "assessment", "life", "diet", "alarm"};
    private String[] colorString = new String[]{"#FE9F21", "#7FCA3C", "#34B7FF", "#4DC7ED", "#8990FA", "#FE7FC2", "#FF5959"};
