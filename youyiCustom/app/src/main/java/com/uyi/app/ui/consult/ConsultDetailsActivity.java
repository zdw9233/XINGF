...
public class ConsultDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onInitLayoutAfter() {
		...
		headerView.showLeftReturn(true).showTitle(true).showRight(false).setTitle("互动详情").setTitleColor(getResources().getColor(R.color.blue));
			...
			public void onResponse(JSONObject data) {
				try {
					...
					if(data.has("assistantAdvice")){
						addYjian(data.getJSONObject("assistantAdvice"),"慢病管理师意见",null);
					}
