 ...
 */
@ContentView(R.layout.sugar_half_year_service)
public class SugarHalfYearActivity extends BaseActivity implements DialogInterface.OnClickListener {
    ...
    public void requestBuyPackage(int id) {
        ...
        RequestManager.postObject(Constens.BUY_SERVICE_PACKAGE, this, object, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                T.showShort(SugarHalfYearActivity.this, "购买成功！");
