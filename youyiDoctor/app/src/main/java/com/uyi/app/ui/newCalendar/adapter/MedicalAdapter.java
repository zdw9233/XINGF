 ...
 *
 */
public class MedicalAdapter extends BaseRecyclerAdapter<Map<String, Object>> {
	...
	public ViewHolder onCreate(ViewGroup parent, int viewType) {
		View view = LayoutInflater.from(context).inflate(R.layout.item_medical_list, parent, false);
    ...
    public static class Holder extends BaseRecyclerAdapter<Map<String, Object>>.Holder {
        public Holder(MedicalAdapter base, View v) {
        	base.super(v);
