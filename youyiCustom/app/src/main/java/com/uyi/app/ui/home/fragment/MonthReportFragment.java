...
import com.uyi.app.ui.home.fragment.adapter.MonthReportAdapter2_1;
...
public class MonthReportFragment extends BaseFragment implements BaseRecyclerAdapter.OnItemClickListener<Map<String,Object>>, EndlessRecyclerView.Pager, SwipeRefreshLayout.OnRefreshListener {
    @ViewInject(R.id.recyclerView)
    private EndlessRecyclerView recyclerView;
    @ViewInject(R.id.swipeRefreshLayout)
    private SwipeRefreshLayout swipeRefreshLayout;
    private LinearLayoutManager linearLayoutManager;
    private MonthReportAdapter2_1 monthReportAdapter2_1;
    ...
    protected void onInitLayoutAfter() {
        ...
        monthReportAdapter2_1 = new MonthReportAdapter2_1(getActivity());
        monthReportAdapter2_1.setOnItemClickListener(this);
        monthReportAdapter2_1.setDatas(datas);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL_LIST));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setProgressView(R.layout.item_progress);
        recyclerView.setAdapter(monthReportAdapter2_1);
    ...
    public void loadNextPage() {
        isLooding = false;
        RequestManager.getObject(String.format(Constens.DOCTOR_HEALTH_MONTH_AND_QUA, 1, pageNo, pageSize),
...
//                            if (pageNo == 1) datas.clear();
                        ...
                        monthReportAdapter2_1.notifyDataSetChanged();
