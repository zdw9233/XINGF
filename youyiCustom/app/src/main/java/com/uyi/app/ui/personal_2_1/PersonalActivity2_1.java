...
public class PersonalActivity2_1 extends BaseFragmentActivity implements HeaderView.OnTabChanage ,AbstractSpinerAdapter.IOnItemSelectListener {
    //个人资料
    ...
    protected void onInitLayoutAfter() {
        headerView.showLeftReturn(true).showTab(false).showTitle(true).setTitle("个人资料") .setTitleColor(getResources().getColor(R.color.blue)).setOnTabChanage(this);
