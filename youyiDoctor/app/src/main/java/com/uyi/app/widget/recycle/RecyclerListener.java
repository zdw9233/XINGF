...
public class RecyclerListener extends RecyclerView.OnScrollListener {
     ...
     * 加载更多的监听
     */
    private com.uyi.app.widget.recycle.RecyclerView.LoadMoreListener mListener;
     ...
     */
    public RecyclerListener(com.uyi.app.widget.recycle.RecyclerView.LoadMoreListener listener) {
        mListener = listener;
    }
