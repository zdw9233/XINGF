...
public class GreateThreeTopActivity extends BaseActivity implements AbstractSpinerAdapter.IOnItemSelectListener {
    ...
    protected void onInitLayoutAfter() {
        headerView.showLeftReturn(true).showTitle(true).showRight(true).setTitle("新建三甲方案").setTitleColor(getResources().getColor(R.color.blue));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.wxys_chose) {
            ...
            new AlertDialog.Builder(GreateThreeTopActivity.this).setTitle("示例").setMessage(s1).setPositiveButton("使用", new DialogInterface.OnClickListener() {
                @Override
            ...
            new AlertDialog.Builder(GreateThreeTopActivity.this).setTitle("示例").setMessage(s2).setPositiveButton("使用", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    yyzd.setText(s2);
                }
            ...
            new AlertDialog.Builder(GreateThreeTopActivity.this).setTitle("示例").setMessage(s3).setPositiveButton("使用", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    xxyydzd.setText(s3);
                }
            ...
            new AlertDialog.Builder(GreateThreeTopActivity.this).setTitle("示例").setMessage(s4).setPositiveButton("使用", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    shzzysx.setText(s4);
                }
            ...
            try {
                ...
                personalHealthManagementTemplateJson.put("customerId", FragmentHealthListManager.customer + "");
