...
@ViewInject(R.id.query_customer_search) private ImageView query_customer_search;
	
	@ViewInject(R.id.query_customer_names) private EditText query_customer_names;
	@ViewInject(R.id.query_customer_cancal) private TextView query_customer_cancal;
