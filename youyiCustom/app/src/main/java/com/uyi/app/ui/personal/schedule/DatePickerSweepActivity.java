...
public class DatePickerSweepActivity extends BaseActivity implements OnClickListener, IOnItemSelectListener {

	
	@ViewInject(R.id.date_picker_hh) TextView  date_picker_hh;
	@ViewInject(R.id.date_picker_mm) TextView  date_picker_mm;
	@ViewInject(R.id.headerView) HeaderView  headerView;
	@ViewInject(R.id.datepicker) DatePicker picker;
	
	private String resultDateFormat = "yyyy/MM/dd HH:mm";
