...
public abstract class BaseAdapter extends
     ...
     * Item点击事件对象
     */
    private com.uyi.xinf.recycle.RecyclerView.ItemClickListener mItemClickListener;

    /**
     * Item长按点击事件对象
     */
    private com.uyi.xinf.recycle.RecyclerView.ItemLongClickListener mItemLongClickListener;
...
//                return newHolder(loadMore);
     ...
     */
    public void setItemClickListener(com.uyi.xinf.recycle.RecyclerView.ItemClickListener itemClickListener) {
     ...
     */
    public void setItemLongClickListener(com.uyi.xinf.recycle.RecyclerView.ItemLongClickListener itemLongClickListener) {
