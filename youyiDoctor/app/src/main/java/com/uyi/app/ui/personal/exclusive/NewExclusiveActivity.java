...
public class NewExclusiveActivity extends BaseActivity implements IOnItemSelectListener {
	...
	@ViewInject(R.id.header) 			private RoundedImageView header;
	@ViewInject(R.id.name) 				private TextView name;
	@ViewInject(R.id.info) 				private TextView info;

	@ViewInject(R.id.new_exclusive_riqi_layout) 		private LinearLayout new_exclusive_riqi_layout;
	@ViewInject(R.id.new_exclusive_riqi) 		private TextView new_exclusive_riqi;
	@ViewInject(R.id.new_exclusive_time_start) 	private TextView new_exclusive_time_start;
	@ViewInject(R.id.new_exclusive_time_end) 	private TextView new_exclusive_time_end;
	@ViewInject(R.id.new_exclusive_address) 	private EditText new_exclusive_address;
	@ViewInject(R.id.new_exclusive_max) 		private EditText new_exclusive_max;
	@ViewInject(R.id.new_exclusive_beans) 		private EditText new_exclusive_beans;
	@ViewInject(R.id.new_exclusive_desc) 		private EditText new_exclusive_desc;

	@ViewInject(R.id.new_exclusive_submit) 		private Button new_exclusive_submit;
	@ViewInject(R.id.new_exclusive_delete) 		private Button new_exclusive_delete;
